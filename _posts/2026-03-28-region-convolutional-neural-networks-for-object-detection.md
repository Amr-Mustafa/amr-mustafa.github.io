It is always helpful to get back to basics and review the key building blocks that shaped deep learning and computer vision as we all know and enjoy today. After all, we don't all have the hardware resources to play around with a 200B-parameters model. In this post, I briefly review the key components of the foundational object detection model, namely Regions with CNN features, or as more commonly known, R-CNN. Developed by Girshick et al. in 2014 at the university of Berkeley, R-CNN took the computer vision community by storm. It marked the rise of CNN-based models for object detection and motivated the development of other more efficient models, in specific Fast R-CNN and Faster R-CNN.


## Architecture Overview
Many object detection pipelines have a feature extraction module 
The architecture of R-CNN is roughly similar to more classical pre-deep-learning object detectors. It consists of four main parts:
1. a region proposal module,
2. a feature extraction module,
3. a classifier module,
4. and a box regression module.
...
## Training
To train such a complex system, it is required to train each module independently. End-to-end training is not possible since the region proposal and classifier modules are, in general, not differentiable components. Hence, the feature extraction module, i.e., the convolutional network is trained independently of the SVM fitting procedure.
